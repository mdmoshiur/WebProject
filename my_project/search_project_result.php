...
<html lang="en" dir="ltr">
  <head>
    ...
    from employee,ft_pt_work,project_name
    where employee.emp_id=ft_pt_work.emp_id and ft_pt_work.project_id=project.project_id and project.project_name like 
    '%$project_name%'";
